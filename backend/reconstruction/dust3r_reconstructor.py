...
VENDOR_DIR = Path(__file__).parent.parent / "vendor" / "dust3r"
...
class Dust3rReconstructor:
    ...
    def reconstruct(self, images_dir: str, output_dir: str, as_pointcloud=True):
        ...
        Output is always flipped to glTF convention (Y up, Z back).
        """
        out_dir = Path(output_dir)
        out_dir.mkdir(parents=True, exist_ok=True)
        
        # Gather all images (escape dir so brackets in the path aren't treated as glob classes)
