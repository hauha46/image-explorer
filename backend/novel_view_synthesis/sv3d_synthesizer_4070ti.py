...
Requires:
  - backend/vendor/generative-models/ (Stability AI SGM repo)
  - backend/vendor/generative-models/checkpoints/sv3d_p.safetensors
"""
...
VENDOR_DIR = Path(__file__).resolve().parent.parent / "vendor" / "generative-models"
