...
```bash
python -m backend.experiments.clip_recond_sweep --inputs 'backend/images/standard_benchmark.jpg' --input-labels 'living_room' --extra-prompt 'sunset' 'a living room at sunset with warm golden hour light' --lambdas 0.0 --neutral-prompt 'a photo of a living room interior' --num-views 10 --num-steps 25 --dtype bf16 --seed 23
```
